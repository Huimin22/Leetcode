...
Set the res to 0. A common mistake when I use greedy. **Be cautious to set the default value to 0,**

have to make sure it can't be negative. If not, try other value.
