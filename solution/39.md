...
You cannot control which elements come next.

You’d have to somehow track "all elements at or after this value" to avoid duplicates.

Using index is simpler because array positions naturally order the recursion.
